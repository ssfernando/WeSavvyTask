...
var googleFitDataSourceManager = require('./googlefitdatasourcemanager.js');

var SCOPES = ['https://www.googleapis.com/auth/fitness.activity.write',
  'https://www.googleapis.com/auth/fitness.body.write', 'https://www.googleapis.com/auth/fitness.location.write'];
var TOKEN_DIR = './.credentials/';
var TOKEN_PATH = TOKEN_DIR + 'fitness-nodejs-quickstart.json';
...
module.exports = function() {
  ...
  fs.readFile('client_secret.json', function processClientSecrets(err, content) {
    ...
    // Authorize a client with the loaded credentials, then call the Fitness API.
    authorize(JSON.parse(content), googleFitDataSourceManager);
  });
};
